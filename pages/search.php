...
<div class="search-results-container">
    ...
    <?php elseif (!empty($search_results)): ?>
        <p class="search_result">총 <?php echo count($search_results); ?>개의 게시물을 찾았습니다.</p>
        <ul class="gallery-grid"> <?php foreach ($search_results as $post): ?>
                <li class="gallery-item"> <a href="main.php?page=gallery_view&id=<?php echo $post['id']; ?>" class="item-link">
                        <?php
