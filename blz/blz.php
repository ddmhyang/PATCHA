...
$blue_content = $stmt_blue->get_result()->fetch_assoc()['content'] ?? '<h2><a href="#/blue">Blue</a></h2>';
$stmt_blue->close();
...
$owen_content = $stmt_owen->get_result()->fetch_assoc()['content'] ?? '<h2><a href="#/owen">Owen</a></h2>';
$stmt_owen->close();
?>
<div class="blz-intro-container">
    ...
    <!-- Blue 소개 섹션 -->
    <div class="intro-column page-content" data-slug="<?php echo $blue_slug; ?>">
        <div class="view-mode">
    ...
    <!-- Owen 소개 섹션 -->
    <div class="intro-column page-content" data-slug="<?php echo $owen_slug; ?>">
        <div class="view-mode">
