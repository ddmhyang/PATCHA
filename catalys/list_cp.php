...
<html lang="ko">
    <head>
        ...
        <style>
            ...
            .list_cp_content::-webkit-scrollbar{
                width: 0px;
            }
    ...
    <body>
        <div class="container">
            ...
            <main>
                ...
                <div class="list_cp_content">

                    <div class="gallery_wrapper">
                        <div class="list_cp_gallery">
                            <div class="list_cp_thum"></div>
                            <a class="list_cp_date">2025 . 08</a>
                        </div>
                        <div class="list_cp_gallery">
                            <div class="list_cp_thum"></div>
                            <a class="list_cp_date">2025 . 08</a>
        ...
        <script>
            ...
            window.addEventListener('load', () => {
                ...
                const imageElement = document.querySelector('.list_cp_pagenation a');
                if (imageElement) {
