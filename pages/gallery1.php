...
<div class="gallery-page-wrapper">
    <div class="left-menu">
        ...
        <a
            href="main.php?page=gallery1&type=gallery2"
            class="<?php echo ($current_gallery_type === 'gallery2') ? 'active' : ''; ?>">Add</a>
        <a
            href="main.php?page=gallery1&type=gallery_etc"
    ...
    <div class="gallery-content-area">
        ...
        <div class="pagination">
            ...
            <a
                href="main.php?page=gallery1&type=<?php echo htmlspecialchars($current_gallery_type); ?>&p=<?php echo $current_page - 1; ?>"
                class="page-link">&laquo; Prev</a>
            <?php endif; ?>

            <?php for ($i = 1; $i <= $total_pages; $i++): ?>
            <a
                href="main.php?page=gallery1&type=<?php echo htmlspecialchars($current_gallery_type); ?>&p=<?php echo $i; ?>"
