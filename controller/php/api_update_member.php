<?php
/*
 * api_update_member.php (★ SQLite 완전 호환 버전)
 */
...
if (empty($member_id) || empty($new_member_name) || $new_points === null) { /* ... 오류 ... */ exit; }

// 6. 로직: 회원 정보 업데이트 (★트랜잭션★)
try {
    $pdo->beginTransaction();
    
    // 6-1. 현재 포인트 조회 (★ FOR UPDATE 제거)
